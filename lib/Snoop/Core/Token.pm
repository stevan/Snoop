...
class Snoop::Core::Token::AddString :isa(Snoop::Core::Token) { field $value :param; method value { $value } }
class Snoop::Core::Token::AddInt    :isa(Snoop::Core::Token) { field $value :param; method value { $value } }
class Snoop::Core::Token::AddFloat  :isa(Snoop::Core::Token) { field $value :param; method value { $value } }
...
class Snoop::Core::Token::Error :isa(Snoop::Core::Token) { field $error :param; method value { $error } }
